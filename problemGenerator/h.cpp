...
//      H = new Formula(Formula::NOT, conjunctions[0]);
      H = conjunctions[0];
    else if (conjunctions.size() == 2)
//      H = new Formula(Formula::NOT, new Formula(Formula::OR,
//						conjunctions[0],
//						conjunctions[1]));
      H = new Formula(Formula::OR,						conjunctions[0],						conjunctions[1]);
    else
//      H = new Formula(Formula::NOT, new Formula(Formula::ORN, conjunctions));
...
//    cout << zeroes << " " << n << "\n";
    ...
    char filename[30];
    if (! neg)
      sprintf(filename, "h_%s%d.prove", zeroes, n);
    else
      sprintf(filename, "h_n_%s%d.prove", zeroes, n);
